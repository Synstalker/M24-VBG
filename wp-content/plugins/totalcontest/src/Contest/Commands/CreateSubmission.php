        ...
        try {
            ...
            foreach ($fields as $field):
                ...
                elseif (in_array($field['type'], ['image', 'video', 'audio', 'file'])):
                    ...
                    if (!empty($urlField) && !empty($submissionAttributes['fields'][$field['name']])):
                        throw new \ErrorException(__('Cannot upload a file and add file through service for the same submission.',
                            'totalcontest'));
                    endif;
                    ...
                    elseif ($_FILES['totalcontest']['error'][$field['name']] === UPLOAD_ERR_OK):
            ...
            if ($submissionPostId instanceof \WP_Error):
                ...
                if (!empty($submissionAttributes['fields']['category'])):
                    wp_set_post_terms($submissionPostId, (array)$submissionAttributes['fields']['category'],
